		...
		<div class="cat-container">	
	    	<div class="cat-head mbottom">
					<h1 class="archive-title">
						<?php _e("Search Results For:", "colorsnap"); ?> <?php echo get_search_query(); ?>
					</h1>
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<article class="item-list mbottom">
			       ...
			       <div class="postmeta">
       		    <p class="vsmall pnone"><?php _e('By', 'colorsnap'); ?> <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) )?>" title="<?php sprintf( esc_attr__( 'View all posts by %s', 'colorsnap' ), get_the_author() ) ?>"><?php echo get_the_author() ?> </a>
