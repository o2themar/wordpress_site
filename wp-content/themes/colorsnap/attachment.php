   			        ...
   			        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?> role="article">
					    <div class="singlebox">
		                    <?php colorsnap_breadcrumbs() ?>
								...
								<?php the_tags('<p class="tags"><span class="tags-title">' . __('Tags:', 'colorsnap') . '</span> ', ' ', '</p>'); ?>
									<p class="tags"></p>
                                    <?php edit_post_link( __( 'Edit', 'colorsnap' ), '<span class="edit-link">', '</span>' ); ?>
								</footer> <!-- end article footer -->
								<nav id="image-navigation" class="site-navigation">
                                    <span class="previous-image"><?php previous_image_link( true, __( '<< Previous', 'colorsnap' ) ); ?></span>
                                    <span class="next-image"><?php next_image_link( true, __( 'Next >>', 'colorsnap' ) ); ?></span>
